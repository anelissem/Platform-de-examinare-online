...
public class FillInTheBlankQuestion extends Intrebare {
    ...
    public FillInTheBlankQuestion(String textIntrebare, String numeAdministrator, LocalDateTime timp, int dificulatate, double punctajMaximIntrebare, String raspunsCorect) {
